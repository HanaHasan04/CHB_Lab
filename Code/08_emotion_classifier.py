"""
An all-emotion Random Forest EMOTION classifier with the evaluation metrics and feature importances.
...
with the target variable being the emotion (anger, sadness, happiness, or neutrality).
"""
...
# selected_categories = ['deaf', 'CODA sign']
# selected_categories = ['CODA sign']
...
plt.tight_layout()
plt.savefig(r"C:\Users\USER\Documents\UniversityProjects\Hagit_Lab\webpage\webpage_files\emotion_classifier\feat_{}.png".format('_'.join(selected_categories)), dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\USER\Documents\UniversityProjects\Hagit_Lab\webpage\webpage_files\emotion_classifier\conf_{}.png".format('_'.join(selected_categories)), dpi=300)
plt.show()

...
**Superivsors:** Prof. Hagit Hel-Or, Rose Stamp, Svetlana Dachkovsky  
...
_(36 FEATURES: for all landmarks - variance of x, y, z coordiantes, largest eigenvalue, mean and variance of speed, volume of the convex hull, total distance covered ; only for the two wrists - mean and variance of distance from body)_  
...
![data_dist_coda_sign](webpage_files\emotion_classifier\conf_hearing.png) ![data_dist_coda_sign](webpage_files\emotion_classifier\conf_CODA speech.png) ![data_dist_coda_sign](webpage_files\emotion_classifier\conf_deaf.png) ![data_dist_coda_sign](webpage_files\emotion_classifier\conf_CODA sign.png)  
![data_dist_coda_sign](webpage_files\emotion_classifier\feat_hearing.png) ![data_dist_coda_sign](webpage_files\emotion_classifier\feat_CODA speech.png) ![data_dist_coda_sign](webpage_files\emotion_classifier\feat_deaf.png) ![data_dist_coda_sign](webpage_files\emotion_classifier\feat_CODA sign.png)  
  
A separate classifier for signers (hearing, CODA speech) and speakers (deaf, CODA sign):  
  
![data_dist_coda_sign](webpage_files\emotion_classifier\conf_hearing_CODA speech.png) ![data_dist_coda_sign](webpage_files\emotion_classifier\conf_deaf_CODA sign.png)  
![data_dist_coda_sign](webpage_files\emotion_classifier\feat_hearing_CODA speech.png) ![data_dist_coda_sign](webpage_files\emotion_classifier\feat_deaf_CODA sign.png)  
  
An all-category emotion classifier:  
  
![data_dist_coda_sign](webpage_files\emotion_classifier\conf_hearing_CODA speech_deaf_CODA sign.png) ![data_dist_coda_sign](webpage_files\emotion_classifier\feat_hearing_CODA speech_deaf_CODA sign.png)  
...
Hearing vs. Deaf vs. CODA speech vs. CODA sign:  
  
![data_dist_coda_sign](webpage_files\category_classifier\conf_hearing_deaf_CODA speech_CODA sign_ALL.png) ![data_dist_coda_sign](webpage_files\category_classifier\feat_hearing_deaf_CODA speech_CODA sign_ALL.png)  
  
Speakers vs. Signers (no CODA included):  
  
![data_dist_coda_sign](webpage_files\category_classifier\conf_hearing_deaf.png) ![data_dist_coda_sign](webpage_files\category_classifier\feat_hearing_deaf.png)  
  
Speakers vs. Signers (no CODA included): Emotion-Wise Analysis  
  
![data_dist_coda_sign](webpage_files\category_classifier\conf_hearing_deaf_angry.png) ![data_dist_coda_sign](webpage_files\category_classifier\conf_hearing_deaf_happy.png) ![data_dist_coda_sign](webpage_files\category_classifier\conf_hearing_deaf_sad.png) ![data_dist_coda_sign](webpage_files\category_classifier\conf_hearing_deaf_neutral.png)  
![data_dist_coda_sign](webpage_files\category_classifier\feat_hearing_deaf_angry.png) ![data_dist_coda_sign](webpage_files\category_classifier\feat_hearing_deaf_happy.png) ![data_dist_coda_sign](webpage_files\category_classifier\feat_hearing_deaf_sad.png) ![data_dist_coda_sign](webpage_files\category_classifier\feat_hearing_deaf_neutral.png)  
  
  
Speakers vs. Signers (CODA included):  
  
![data_dist_coda_sign](webpage_files\category_classifier\conf_hearing_deaf_CODA speech_CODA sign.png) ![data_dist_coda_sign](webpage_files\category_classifier\feat_hearing_deaf_CODA speech_CODA sign.png)  
  
  
Speakers vs. CODA Speakers:  
  
![data_dist_coda_sign](webpage_files\category_classifier\conf_hearing_CODA speech.png) ![data_dist_coda_sign](webpage_files\category_classifier\feat_hearing_CODA speech.png)  
  
Deaf Signers vs. CODA Signers:  
  
![data_dist_coda_sign](webpage_files\category_classifier\conf_deaf_CODA sign.png) ![data_dist_coda_sign](webpage_files\category_classifier\feat_deaf_CODA sign.png)  
...
Hearing:  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_hearing_neutral-happy.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_hearing_neutral-happy.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_hearing_neutral-happy.png)  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_hearing_neutral-sad.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_hearing_neutral-sad.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_hearing_neutral-sad.png)  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_hearing_neutral-angry.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_hearing_neutral-angry.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_hearing_neutral-angry.png)  
  
  
CODA Speech:  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_CODA speech_neutral-happy.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_CODA speech_neutral-happy.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_CODA speech_neutral-happy.png)  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_CODA speech_neutral-sad.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_CODA speech_neutral-sad.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_CODA speech_neutral-sad.png)  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_CODA speech_neutral-angry.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_CODA speech_neutral-angry.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_CODA speech_neutral-angry.png)  
  
  
Deaf:  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_deaf_neutral-happy.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_deaf_neutral-happy.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_deaf_neutral-happy.png)  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_deaf_neutral-sad.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_deaf_neutral-sad.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_deaf_neutral-sad.png)  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_deaf_neutral-angry.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_deaf_neutral-angry.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_deaf_neutral-angry.png)  
  
  
CODA Speech:  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_CODA sign_neutral-happy.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_CODA sign_neutral-happy.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_CODA sign_neutral-happy.png)  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_CODA sign_neutral-sad.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_CODA sign_neutral-sad.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_CODA sign_neutral-sad.png)  
![data_dist_coda_sign](webpage_files\binary_classifier\conf_CODA sign_neutral-angry.png) ![data_dist_coda_sign](webpage_files\binary_classifier\feat_CODA sign_neutral-angry.png) ![data_dist_coda_sign](webpage_files\binary_classifier\bestfeat_CODA sign_neutral-angry.png)
